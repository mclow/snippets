...
{
	{
	static_assert( std_bit::countl_zero(23U)           == sizeof(unsigned) * 8 - 5, "");
	static_assert( std_bit::countl_zero(23UL)          == sizeof(unsigned long) * 8 - 5, "");
	static_assert( std_bit::countl_zero(23ULL)         == sizeof(unsigned long long) * 8 - 5, "");
	static_assert( std_bit::countl_zero(std::byte{23}) == 8 - 5, "");

	static_assert( std_bit::countl_zero(0U)           == sizeof(unsigned) * 8, "");
	static_assert( std_bit::countl_zero(0UL)          == sizeof(unsigned long) * 8, "");
	static_assert( std_bit::countl_zero(0ULL)         == sizeof(unsigned long long) * 8, "");
	static_assert( std_bit::countl_zero(std::byte{0}) == 8, "");
	}
	...
	static_assert( std_bit::countr_zero(0U)           == sizeof(unsigned) * 8, "");
	static_assert( std_bit::countr_zero(0UL)          == sizeof(unsigned long) * 8, "");
	static_assert( std_bit::countr_zero(0ULL)         == sizeof(unsigned long long) * 8, "");
